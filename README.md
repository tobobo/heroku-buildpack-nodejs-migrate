Heroku Buildpack for Node.js with Database Migrations
=====================================================

TL;DR Set the NPM_MIGRATION_SCRIPT config var to the name of the entry in "scripts" in your package.json that corresponds to your production migrations.


This is (a fork of) the official [Heroku buildpack](http://devcenter.heroku.com/articles/buildpacks) for Node.js apps. If you fork this repository, please **update this README** to explain what your fork does and why it's special.
